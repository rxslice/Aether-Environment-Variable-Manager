...
export const JwtIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25l3 3m0 0l-3 3m3-3h-4.5A2.25 2.25 0 0012 9.75v1.5m-3.75 5.25l-3-3m0 0l3-3m-3 3h4.5A2.25 2.25 0 0112 14.25v-1.5" />
  </svg>
);
